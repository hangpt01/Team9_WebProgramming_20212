								...
								<div class="item">	
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="/web-programing/Project/eshop/public/uploads/banetti-foods.jpg" alt="" />
													<h2>$12</h2>
													<p>Baneti noodle</p>
													<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
												</div>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="/web-programing/Project/eshop/public/uploads/images.jpg_post_thumb.jpg" alt="noodle" style="overflow: hidden;"/>
													<h2>$1</h2>
													<p>Milo</p>
													<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
												</div>
										...
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													...
													<img src="/web-programing/Project/eshop/public/uploads/Eom0oSPCNldnSHUnkVvRmUIGqd34bJemcDS2U6dyt6vvYk8SnfpG614gmNYe.jpg" alt="" />
													<h2>$3</h2>
													<p>Go up candy</p>
													<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
												</div>
